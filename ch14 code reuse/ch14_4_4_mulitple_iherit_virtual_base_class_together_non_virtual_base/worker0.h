...
class Waiter2 : public Worker {
    private:
    public:
        Waiter2() : Worker() {
            std::cout << "constructor Waiter2() called:" << std::endl;
        }
        Waiter2(const std::string &s, long n, int p = 0) : Worker(s, n) {
            std::cout << "constructor Waiter2(const std::string &s, long n, int p = 0) called:" << std::endl;
        }
        void Show() const;
};

class Singer2 : public Worker {
    private:
    public:
        Singer2() : Worker() {
            std::cout << "constructor Singer2() called:" << std::endl;
        }
        Singer2(const std::string &s, long n, int v = 0) : Worker(s, n) {
            std::cout << "constructor Singer2(const std::string &s, long n, int v = other) called:" << std::endl;
        }
        void Show() const;
};


class Singer_Waiter_Mix : public Singer, public Waiter, public Singer2, public Waiter2 {
    ...
    public:
        ...
        */
        Singer_Waiter_Mix(const std::string &s, long n, int p = 0, int v = 0)
        : Singer(s, n, v), Waiter(s, n, p), Singer2(s, n, v), Waiter2(s, n, v) {
