...
int main () {
    ...
    cout << sizeof (s1) << endl;
    cout << sizeof (s2) << endl;
    auto tuple = TEST_MACRO("abcdefg", 2.22, 3.333); //     auto tuple = std::make_tuple("abcdefg" , __em_asm_sig_builder<__typeof__(__em_asm_make_type_tuple(2.22, 3.333))>::buffer, 2.22, 3.333);
