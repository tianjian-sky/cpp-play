...
message("_ZLIB_SEARCH_ROOT:${_ZLIB_SEARCH_ROOT}")
message("_ZLIB_SEARCHES：${_ZLIB_SEARCHES}")
# Normal search.
set(_ZLIB_x86 "(x86)")
...
if(NOT ZLIB_LIBRARY)
  ...
  message("before   ZLIB_LIBRARY_RELEASE:${ZLIB_LIBRARY_RELEASE}")
  message("before   ZLIB_LIBRARY_DEBUG:${ZLIB_LIBRARY_DEBUG}")
...
message("ZLIB_FOUND:${ZLIB_FOUND}")
message("ZLIB_FOUND:${ZLIB_FOUND}")
get_target_property(ipd ZLIB::ZLIB IMPORTED_LOCATION_DEBUG)
get_target_property(ip ZLIB::ZLIB IMPORTED_LOCATION)
get_target_property(implib ZLIB::ZLIB IMPORTED_IMPLIB)
get_target_property(implibd ZLIB::ZLIB IMPORTED_IMPLIB_DEBUG)
message("ZLIB IMPORTED_LOCATION_DEBUG:${ipd}")
message("ZLIB IMPORTED_LOCATION:${ip}")
message("ZLIB IMPORTED_IMPLIB:${implib}")
message("ZLIB IMPORTED_IMPLIB_DEBUG:${implibd}")
